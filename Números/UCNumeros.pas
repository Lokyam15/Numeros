...
if n < 20  then        //1..20
r:= unidad[n]
else if (n mod 10 = 0 ) and (n<100) then   //20,30,40,50,60,70,80,90
r:= decena[n div 10]
else if (n div 10 = 2) then          //21,22,23,24,25,26,27,28,29
r:='veinti'+ unidad[n mod 10]
else if n<100 then             //31..99 - {20,30,40,50,60,70,80,90}
r:= decena[n div 10]+' y '+unidad[n mod 10]
//centena
else if ((n div 100 = 1) and (n mod 100 = 0)) then    //100
r:='cien'
else if (n<1000) then                      //101..999
r:= centena[n div 100]+' '+ConvertirALiteral(n mod 100)
//unidad de mil
else if n < 2000 then                  //1000..1999
r:='mil '+ConvertirALiteral(n mod 1000)
//decena de mil (casos especiales)
{21000..21999 31000..31999 41..}
else if ((n div 1000) mod 10 = 1) and (n < 100000)   then
r:= decenamil[n div 10000]+' mil '+ConvertirALiteral(n mod 1000)
//centena de mil (casos especiales)
{121 131..191 221 231..291 321 331..391 .. 921..991}
else if ((n div 1000) mod 10 = 1) and (n < 1000000) then
r:= centena[n div 100000]+' '+decenamil[n div 10000 mod 10]+' mil '+ConvertirALiteral(n mod 1000)
//Caso general de MIL
//2000..999 999-{21000..21999 31000..31999..}
else if n < 1000000 then
r:=ConvertirALiteral(n div 1000)+ ' mil '+
ConvertirALiteral( n mod 1000)
//unidad de millon
else if n <2000000 then
r:='un millon '+ConvertirALiteral(n mod 1000000)
//21000000..21999999 31000000..31999999 41 51 61 71 81 91 millones
else if ((n div 1000000) mod 10 = 1) and (n < 100000000)   then
r:= decenamil[n div 10000000]+' millones '+ decenamil[n div 10000 mod 10]+' mil '+ConvertirALiteral(n mod 1000)

//121000000..121999999 131000000..131999999 141..191 221..291 321..391 millones
else if ((n div 1000000) mod 10 = 1) and (n < 1000000000) then
r:= centena[n div 100000000]+' '+decenamil[n div 10000000 mod 10]+' millones '
+ConvertirALiteral(n mod 1000000)


//millones caso general
else if (n < 1000000000) then
r:=ConvertirALiteral(n div 1000000)+' millones '+
ConvertirALiteral(n mod 1000000);

// Número máximo: 4 294 967 295
ConvertirALiteral:= r
end;
